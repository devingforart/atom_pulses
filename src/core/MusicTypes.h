...
struct Pattern {
    ...
    bool attentionDirected{};
    std::size_t structuralBreathBars{};
    std::size_t phraseBreathsCreated{};
    std::size_t attentionNotesRemoved{};
    std::size_t harmonicFloorNotesCreated{};
    ...
    bool thematicOwnershipDirected{};
    std::size_t foregroundTracksBefore{};
    std::size_t foregroundTracksAfter{};
    std::size_t thematicTracksConsolidated{};
    std::size_t thematicNotesReassigned{};
    std::size_t contentLaneCount{};
    std::size_t timbralHandoffDestinations{};
    std::size_t timbralHandoffWindows{};
    std::size_t timbralHandoffNotes{};
    bool exactInstrumentCastPublished{};
